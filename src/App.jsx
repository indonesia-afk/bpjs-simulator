...
export default function BPJSSimulatorApp() {
  ...
  const SegmentTab = ({ id, icon: Icon, label }) => (
    <button
      ...
      className={`flex-1 flex flex-col items-center justify-center p-3 transition-all ${segment === id
  ...
  const RiskButton = ({ id, icon: Icon, label, color }) => (
    <button
      ...
      className={`flex-1 p-3 rounded-lg border flex flex-col items-center gap-2 transition-all ${riskScenario === id
